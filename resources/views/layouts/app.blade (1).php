                                ...
                                <li>
                                  <a class='dropdown-trigger' data-target='dropdown1' style=" height: 47%; padding: 0;"><i class="material-icons icon1">person</i></a>
                                    <ul id='dropdown1' class='dropdown-content'>
                                        ...
                                        <li class="divider" tabindex="-1"></li>
                                        <li>
                                            <a class="listName1" href="{{ route('logout') }}"
                            ...
                            <table>
                                <tr style="border-bottom: 0;">
                                    <td class="center" style="border-right: 1px solid white; width: 25% ">
                                        <a href="{{url('buy-chips')}}">
                                            <span class="l3"><i class="fas fa-dice fa-lg" style="padding-bottom: 10px;"></i><br><span id="chips"> </span> Chips</span>
                                        </a>
                                    </td>
                                    <td  class="center" style="border-right: 1px solid white; width: 25% "><span class="l3" id="user"><i class="far fa-user fa-lg" style="padding-bottom: 10px;"></i><br></span></td>
                                    <td class="center" style="width: 25% "><a class="center l3" href="{{url('mymatches')}}" ><i class="fas fa-history fa-lg" style="padding-bottom: 10px;"></i><br>History</a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
