              ...
              <tr>
                ...
                <td>
                  <form style="margin-top: -10px;" action="{{url('play_match')}}" method="POST">
                    ...
                    <button onclick="playbuttonclicked()" class="btn right" type="submit">Play</button>
                </td>
                </form>
              </tr>
              @endforeach
          ...
          <table>
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <input type="hidden" name="match_id" value="{{$data->id}}" />
                  <span class="text-success text-bold matchbox-amount ng-binding"><img class="spinImg"
                      src="images/chip2.png" height="18px" alt=""> {{$data->amt}}</span>
              </tr>
              @endforeach
            </tbody>
          </table>
